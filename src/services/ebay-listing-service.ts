...
import { EbayListing, CreateEbayListingInput, ListingStatus } from '../types/listing'
import { WebhookService } from '../webhooks/webhook-service'

export class EbayListingService {
  constructor(
    private readonly listings: EbayListingRepository,
  ...
  async create(input: CreateEbayListingInput) {
  ...
  private async transition(listing: EbayListing, nextStatus: ListingStatus) {
